...
def test_staging_file(tmp_dir, dvc):
    ...
    staging_odb, _, obj = stage(local_odb, (tmp_dir / "foo").fs_path, fs, "md5")
    ...
    path_info = local_odb.hash_to_path(obj.hash_info.value)
...
def test_staging_dir(tmp_dir, dvc):
    ...
    staging_odb, _, obj = stage(local_odb, (tmp_dir / "dir").fs_path, fs, "md5")
